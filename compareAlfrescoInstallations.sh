...
FILTER_STRINGS="*BAK*|CONTRIBUTING|RELEASE-NOTES|README|NOTICE|LICENSE|CREDITS|VERSIONS|examples|java|LibreLogo|templates|terminfo"
FILTER="$FILTER_DIRS|$FILTER_EXTENSIONS|$FILTER_STRINGS"
clean; clean;
diff -qr $ODIR $NDIR | \
grep -E -v $FILTER | \
sort ;

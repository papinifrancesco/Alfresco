...
FILTER_DIRS="\/alfresco-aos-module|classes\/alfresco\/messages|site-webscripts\/org\/alfresco|webapps\/manager|webapps\/host-manager|tomcat\/logs|tomcat\/work|tomcat\/temp|libreoffice\/program|libreoffice/share"

...
alf_jmx_connect ()
{
/opt/alfresco-one/java/bin/java -jar /opt/alfresco-one/scripts/jmxterm-1.0-alpha-4-uber.jar -l service:jmx:rmi:///jndi/rmi://localhost:50500/alfresco/jmxrmi -u controlRole -p change_asap -n
}

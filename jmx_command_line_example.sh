...
alf_jmx_connect ()
{
/opt/alfresco/java/bin/java -jar /opt/alfresco/scripts/jmxterm-1.0.1.jar -l service:jmx:rmi:///jndi/rmi://localhost:50500/alfresco/jmxrmi -u controlRole -p change_asap -n
}
